...
@router.get("/metrics/{symbol}", response_model=PortfolioMetrics)
async def get_portfolio_metrics(
    symbol: str,
    period: str = "1Y"
):
    """Get portfolio metrics for a specific stock."""
    ...
    try:
        ...
        metrics = await PortfolioService.calculate_portfolio_metrics(df)
